...
{
    //localSetting信息
    //holdPage:  引发hold事件的页面:1-Count, 2-Memory, 3-both
    //holdIndex: 引发hold事件的item在对应容器中的序号
    //state:     此时要进行的操作：0-无，1-编辑事件，2-添加事件,3-查看事件
    //PivotLoad: 表示当前应该启动的枢轴项序号 
    //isIn;      是否是启动
    public partial class App : Application
    {
        private static MainViewModel viewModel = null;
        public static MDayViewModel myViewModel = null;
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            myViewModel = new MDayViewModel();
            myViewModel.LoadData();
            localSettings.Values["isIn"] = true;
            localSettings.Values["addDayFromDetail"] = false;
            localSettings.Values["PivotLoad"] = 0;
        }
